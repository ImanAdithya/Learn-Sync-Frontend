        ...
        <div className="bg-[#E9EFF2] flex items-center justify-center font-anek h-screen">
            <div className="bg-white flex items-center justify-center flex-col w-[80%] h-[80%] py-32 rounded-xl">
                ...
                <div className="flex gap-2 mt-10">
                    <p className="text-[16px] font-medium text-gray-500">Already have an account ?</p>
                    <a className="text-[#4B2FC8] text-[16px] font-semibold cursor-pointer" onClick={() => navigate("/login")}>SignIn now</a>
                </div>
            </div>
        </div>
    )
